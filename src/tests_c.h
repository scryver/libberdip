...
internal inline void \
i_expect_almost_equal_##type##bits##_(const char *file, u32 line, \
const char *nameA, const char *nameB, \
type##bits result, type##bits expectation, \
type##bits epsilon) \
{ \
...
internal inline void \
i_expect_bool_equal_##type##bits##_(const char *file, u32 line, \
const char *nameA, const char *nameB, \
...
internal inline void \
i_expect_bool_not_equal_##type##bits##_(const char *file, u32 line, \
const char *nameA, const char *nameB, \
b##bits result, b##bits expectation) \
{ \
    result = result ? 1 : 0; \
...
internal inline void
i_expect_string_equal_(const char *file, u32 line, const char *nameA, const char *nameB,
                        String result, String expectation)
{
    if (!strings_are_equal(result, expectation)) {
        test_error("%s:%d: %s == %s", file, line, nameA, nameB);
...
internal inline void
i_expect_string_not_equal_(const char *file, u32 line, const char *nameA, const char *nameB,
                        String result, String expectation)
{
    if (strings_are_equal(result, expectation)) {
        test_error("%s:%d: %s != %s", file, line, nameA, nameB);
...
internal inline void
i_expect_ptr_equal_(const char *file, u32 line, const char *nameA, const char *nameB,
...
internal inline void
i_expect_ptr_not_equal_(const char *file, u32 line, const char *nameA, const char *nameB,
                    void *result, void *expectation)
{
    if (!(result != expectation)) {
        test_error("%s:%d: %s == %s", file, line, nameA, nameB);
...
internal inline void
i_expect_string_contains_(const char *file, u32 line, const char *nameA, const char *nameB,
