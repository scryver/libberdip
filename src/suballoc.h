...
internal void *sub_alloc(SubAllocator *allocator, u32 requestSize, MemoryAllocFlags allocInfo = default_memory_alloc());
...
internal void *sub_realloc(SubAllocator *allocator, void *pointer, u32 requestSize, MemoryAllocFlags allocInfo = default_memory_alloc());
...
internal String sub_alloc_string(SubAllocator *allocator, u32 stringLength, MemoryAllocFlags allocInfo = default_memory_alloc());
